...
tac = skimage.transform.downscale_local_mean(tac,(1,16,16))
lungs = skimage.transform.downscale_local_mean(lungs,(16,16))
...
model = architecture.residual_unet_model((3,32,32))
