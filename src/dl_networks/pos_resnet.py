...
class ResnetNetAsBlock(object):
    @staticmethod
    def build(input_shape, input, num_outputs, block_fn, repetitions):
        ...
        dense = Dense(output_dim=num_outputs, init="he_normal", activation="tanh")(flatten1)
        return dense

    @staticmethod
    def build_resnet_18(input_shape, input, num_outputs):
        return ResnetNetAsBlock.build(input_shape, input, num_outputs, basic_block, [2, 2, 2, 2])

    @staticmethod
    def build_resnet_34(input_shape, input, num_outputs):
        return ResnetNetAsBlock.build(input_shape, input, num_outputs, basic_block, [3, 4, 6, 3])

    @staticmethod
    def build_resnet_50(input_shape, input, num_outputs):
        return ResnetNetAsBlock.build(input_shape, input, num_outputs, bottleneck, [3, 4, 6, 3])

    @staticmethod
    def build_resnet_101(input_shape, input, num_outputs):
        return ResnetNetAsBlock.build(input_shape, input, num_outputs, bottleneck, [3, 4, 23, 3])
...
class posResnet(object):    
    ...
    def get_posResnet(signal_shape, atlas_shape):
        ...
        out_A = ResnetNetAsBlock.build_resnet_34(signal_shape, input_signal, 30)
        out_B = ResnetNetAsBlock.build_resnet_18(atlas_shape, input_atlas, 10)
