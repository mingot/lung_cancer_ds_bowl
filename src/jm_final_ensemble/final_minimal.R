...
df_nodule = df_nodule[,.(patientid, maxscorenod_nslicespread_sd, maxscorenod_PC1_lbp, maxscorenod_10_lungmask, maxscorenod_y, maxscorenod_PC3_lbp,
                         maxdiamnod_PC2_hog, maxdiamnod_x, maxdiamnod_40_nodeverticalposition)]
