...
OUTPUT_DL12 = '/home/mingot/dl3/dl3_train_v04.csv'
...
OUTPUT_MODEL =  wp + 'models/jm_patches_dl3_v04.hdf5'  # OUTPUT_MODEL = wp + 'personal/jm_patches_train_v06_local.hdf5'
LOGS_PATH = wp + 'logs/%s' % 'malign_v04' #str(int(time()))
...
#                                 os.path.join(PATCHES_PATH,'dl3_v04_x_test.npz'),
#                                 os.path.join(PATCHES_PATH,'dl3_v04_y_test.npz'),
#                                 __load_and_store,
#                                 parallel=True)
