...
x_train = np.load(os.path.join(PATCHES_PATH, 'dl3_v08_x_train.npz'))['arr_0']
y_train = np.load(os.path.join(PATCHES_PATH, 'dl3_v08_y_train.npz'))['arr_0']
y_train = np.expand_dims(y_train, axis=1)
x_test = np.load(os.path.join(PATCHES_PATH, 'dl3_v08_x_test.npz'))['arr_0']
y_test = np.load(os.path.join(PATCHES_PATH, 'dl3_v08_y_test.npz'))['arr_0']
